...
problems <- paste(c('Jaleise', # failed to connect to database
                    'Janelle', # nothing in gdb
                    'Joanne',  # was polygon - exported out of .gdb
                    'Julia',   # invalid raster data set
                    'Nicole',  # nothing in gdb
                    'Zoe'),    # was polygon of top ten sites - exported out of .gdb
                  collapse = '|')
...
### .Ruben (40) - dropped a lot of areas - mask issues?
### .Tyler (43) - one or more masks is very wrong
### .Keene (28) - small problem with a mask (no points off if fixed)
