...
### ..Kat Leigh : wrong extent, wrong resolution, major issues (fixed)
### ..Leana :     wrong CRS via processing extent settings? (fixed)
### .Rachel :     wrong CRS via processing extent settings?

### ..Benson  - missing some areas (fixed)
### ..Gabriel  - lots missing - maybe wind classes? (fixed) - still has urban mask issues
### ..Gavi  - small amount missing (no points off, fixed)
### .Juan E  - small mask issue? (no points off if fixed)
### ..Waldo  - wrong wind classes (fixed)
### ..Ruben  - dropped a lot of areas - mask issues?
### ..Tyler  - one or more masks is very wrong (fixed in class, but not in gdb)
### ..Keene  - small problem with a mask (no points off, fixed)

### julia - urban mask issue... small difference, ok
### joanne - still issues with raster not in results.gdb
