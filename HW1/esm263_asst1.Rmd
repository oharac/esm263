...
coal_fills <- c('grey20', 'grey40', 'grey60', 'grey80', '#ffffdd', 'black')
coal_cols  <- c('grey50', 'grey50', 'grey50', 'grey50', '#ffffaa', '#662222')
...
inverse_plot <- ggplot() +
  ...
  theme(text = element_text(size = 6, color = 'white', family = 'AvantGarde'), ### default text
        ...
        plot.background = element_rect(color = 'grey50', fill = 'grey10', size = 1)) +
  coord_sf(expand = FALSE) +
